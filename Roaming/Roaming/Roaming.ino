...
#define MotorA_PWMA    7  //定義 ENA (PWM調速) 接腳
#define MotorB_PWMB    6  //定義 ENB (PWM調速) 接腳

// HC-SR04 超音波測距模組
#define US_Trig  A3  //定義超音波模組 Trig 腳位
#define US_Echo  A2  //定義超音波模組 Echo 腳位

// 伺服馬達(舵機)
#define Servo_Pin      A4  // 定義伺服馬達輸出腳位(PWM)
...
int detection()    // 超音波偵測函數 三個角度讀取距離數值
{
    ...
    if(F_Distance < 25)  // 超音波感測器偵測前方的距離小於25公分
    {
        ...
        L_Distance = Ask_Distance(170);  // 讀取右方距離, 請依照您組裝後的實際狀況調整舵機角度
